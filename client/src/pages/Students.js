...
const Students = () => {
    ...
    <div id="div1">    
      ...
      <div className='stu-table' key={students.empilid}>
         <h1>{students.map((student) => (<h5 className="table-data">{student.emplid} {student.firstName} {student.mi} {student.lastName} {(student.dob).substring(0, 10)} {student.email} {student.phone}</h5>))}</h1>
